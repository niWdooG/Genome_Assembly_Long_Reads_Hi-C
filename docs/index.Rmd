...
`/home/Downloads/ONT/CRR302667.fastq.gz` type the path to the ONT reads and save `read_list.txt`.<br/>
...
<span style="color:black">
In this step, we may need to remove contaminants, e.g., chloroplast, mitochondrial and/or bacterial sequences.<br/> 
...
<div class="alert alert-info">
<span style="color:black">
Just out of curiosity, you may extract the looped sequences in the same manner and [BLAST them](https://blast.ncbi.nlm.nih.gov/Blast.cgi?PROGRAM=blastn&PAGE_TYPE=BlastSearch&LINK_LOC=blasthome) to verify if these fragments do represent chloroplast, mitochondrial and bacterial sequences.
</div>        
</span>
...
<span style="color:black">
In order to improve the draft genome by searching misassemblies and other inconsistencies and correcting them, we will polish our assembly with the highly accurate long HiFi reads.<br/>
...
<span style="color:black">
We will use [Qualimap](http://qualimap.conesalab.org/) to (1) examine sequencing alignment data according to the features of the mapped reads and their genomic properties; (2) get an overall view of the data that may help in decision-making for further analysis.  
...
<span style="color:black">
We may also use [the QUality ASsessment Tool](http://quast.sourceforge.net/docs/manual.html) (QUAST) to get a summary report on our genome as well as to assess the quality of this assembly based on a reference.
